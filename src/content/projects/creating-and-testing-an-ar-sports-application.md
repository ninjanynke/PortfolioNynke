---
title: "Creating an AR sports application"
summary: "For my Artificial Intelligence bachelor thesis, I created an Augmented Reality programme for sports exercises. I wanted to see whether an AR sports application could benefit user's sporting, by using gamification approaches. My results showed that scores on game flow and the duration of the workout were significantly higher for the gamified group versus the baseline group."
...
![Picture of the experiment set up.](./creating-and-testing-an-ar-sports-application/images/screenshot-2021-12-27-at-19.47.24.png)
